...
<div class="container-fluid mx-md-auto custom-fixed-top">
    <div class="row">
        <div class="col text-center">
            <h3>DANH SÁCH BẢNG MÃ VẢI THỊNH CƯỜNG</h3>
            <hr>
        </div>
    </div>
    <div class="row">
        ...
        <div class="kha_list">
            ...
            <div class="kha_list_item1">
                <a href="./fabric_add.php" class="btn btn-info">Add</a>
            </div>
        </div>
    </div>
    <div class="row">
                    ...
                    <?php
                        ...
                        if ($colors) {
                            foreach ($colors as $color) {
                                ...
                                href=\"color_edit.php?sid=".$color["id"]."&menu=product\">Edit</a> 
                                
                                <a class=\"btn btn-info btn-sm\"
                                href=\"color_delete.php?sid=".$color["id"]."&menu=product\">Delete</a>
                                </td>";
                                echo "</tr>";
                            }
                        } else {
