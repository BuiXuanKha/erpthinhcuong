...
<?php 
    ...
    $department_id = $_SESSION['department_id'];
        ...
        $getEmployees = getRecordTableById('tbl_employee','department_id',$department_id);
    ?>
...
<div class="container custom-fixed-top">
    ...
    <form action="job_add_updatefile_process.php?sid=<?php echo $sid;?>" method="POST" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-12">
                <div class="mb-3">
                    <input type="hidden" name="statusjob" value="<?php echo $job['statusjob'];?>">
                    <label for="jobdetails" class="form-label">Job Details:</label>
                    <textarea class="form-control" id="jobdetails" name="jobdetails" style="height: 298px;" required><?php echo $job['job_details'];?>
                </textarea>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="notes" name="notes" style="height: 298px;"
                        required><?php echo $job['note'];?></textarea>
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <select class="form-select" name="employee" id="employee">
                        ...
                        if ($getEmployees) {
                                foreach ($getEmployees as $getEmployee) {
                                    $selected = ($getEmployee['id'] == $job['process_employee_id']) ? 'selected' : '';
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="deadline" name="deadline"
                        min="<?php echo $job['create_at']; ?>" max="" required
