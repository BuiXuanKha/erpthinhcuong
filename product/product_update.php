<?php 
    ...
    $product_vendor_id = $_GET['product_vendor_id'];
    $product_vendors = getRecordTableById('tbl_product_vendor', 'id', $product_vendor_id);
...
<div class="container custom-fixed-top">
    <form id="upload-form" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-12">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="product_code" name="product_code"
                        value="<?php echo $product_vendor['product_vendor_code']; ?>" required>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="netweight" name="netweight"
                        value="<?php echo $product_vendor['netweight']; ?>" required min="0" step="0.1">
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <select name="style_id" class="form-select" id="style_id">
                        <<?php 
                            ...
                            if ($styles) {
                                foreach ($styles as $style) {
                                    $selected = ($style['id'] == $product_vendor['style_id']) ? 'selected' : '';
                                    echo "<option value=".$style['id']." ".$selected.">".$style['fullname']."</option>";
                                }
                            } else {
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="mb-3">
                    <label for="dimension" class="form-label">Dimension(LxDxH):</label>
                    <div class="form-row">
                        <div class="col">
                            <input type="number" class="form-control" id="dimension_l" name="dimension_l"
                                value="<?php echo $product_vendor['dimension_l']; ?>" required min="0"  step="0.1"> cm
                        </div>
                        <div class="col">
                            <input type="number" class="form-control" id="dimension_w" name="dimension_w"
                                value="<?php echo $product_vendor['dimension_w']; ?>" required min="0" step="0.1"> cm
                        </div>
                        <div class="col">
                            <input type="number" class="form-control" id="dimension_h" name="dimension_h"
                                value="<?php echo $product_vendor['dimension_h']; ?>" required min="0" step="0.1"> cm
                        </div>
                    </div>
...
document.getElementById('upload-form').addEventListener('submit', function(e) {
    ...
    var product_vendor_ids = <?php echo json_encode($product_vendor_id); ?>;
    ...
    xhr_formDataInput.onload = function() {
        if (xhr_formDataInput.status === 200) {
            ...
            if (selectedFilesImages.length <= 0) {
                ...
                formDataImage.append('product_vendor_id', product_vendor_ids);
