...
<div class="container-fluid mx-md-auto custom-fixed-top">
    ...
    include '../function/function.php';
        ...
        $employee1s = getRecordTableById('tbl_employee', 'id', $qcteamjob['employee_id']);
        ...
        $employee2s = getRecordTableById('tbl_employee', 'id', $qcteamjob['assignee_id']);
        ...
        $job_files = getRecordTableById('tbl_qcteamjob_file', 'qcteamjob_id',$qcteamjob['id']);

        $job_images = getRecordTableById('tbl_qcteamjob_image', 'qcteamjob_id',$qcteamjob['id']);
            ...
            <div class="card my-4">
                <div class="card-header font-weight-bold d-flex justify-content-between ">
                    ...
                    <a class="btn btn-info" href="javascript:void(0);"
                        onclick="logAddFile('/thinhcuong/qcteamjob/job_add_updatefile.php?sid=<?php echo $sid; ?>', '<?php echo $_SESSION['fullname'].' '. $_SESSION['department_name']; ?>', 'đã nhấp vào chức năng add file')">Edit</a>
                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <!-- Nội dung công việc -->
                            <pre><?php echo trim($qcteamjob['job']); ?></pre>
                        </div>
                        <div class="col-md-6">
                            <p class="font-weight-bold">Planning:</p>
                            <?php echo "from: ".$qcteamjob['create_at']."  to: ".$qcteamjob['job_deadline'] ;?>
                            <hr>
                            <p class="font-weight-bold">Status:</p> <?php echo $qcteamjob['statusjob'];?>
                            <hr>
                            <p class="font-weight-bold">Notes:</p><?php echo $qcteamjob['note'];?>
                            <hr>
                    ...
                    <!-- <div class="d-flex justify-content-between">
                        ...
                        <a class="btn btn-info" href="javascript:void(0);"
                            onclick="logAddFile('/thinhcuong/qcteamjob/job_add_updatefile.php?sid=<php echo $sid; ?>''Thanh nguyễn', 'đã nhấp vào chức năng add file')">Add
                            file</a>
                    </div> -->
                    ...
                    <!-- <div class="d-flex justify-content-between">
                        ...
                        <a class="btn btn-info"
                            href="/thinhcuong/qcteamjob/job_add_updatefile.php?sid=<php echo $sid; ?>">Add file</a>
                    </div> -->
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="d-flex justify-content-end">
                <a class="btn btn-info"
                    href="/thinhcuong/qcteamjob/job_finish.php?sid=<?php echo $qcteamjob['id'];?>">Finish</a>
